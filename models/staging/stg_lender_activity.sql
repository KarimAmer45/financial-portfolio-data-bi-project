-- dbt-inspired staging model: standardize lender-level SBA activity.
-- Source equivalent: data/processed/sba_7a_lender_activity_fy2024.csv

CREATE OR REPLACE VIEW staging.stg_lender_activity AS
SELECT
...
FROM raw.sba_7a_lender_activity_fy2024;
